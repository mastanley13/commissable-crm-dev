...
export function ProductDetailsView({
  ...
  const toggleDetails = () => setDetailsExpanded(previous => !previous)
          ...
          <div className="mb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 rounded-md bg-gray-200 px-2 py-1 text-xs font-medium text-gray-600 transition hover:bg-gray-300 hover:text-gray-800"
            ...
            <div className="flex flex-wrap items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700">
              ...
              {product.vendor && (
                <>
                  ...
                  <span className="text-gray-600">{product.vendor.accountName}</span>
                </>
              )}
              {statusBadge}
            </div>
