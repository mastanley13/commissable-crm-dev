...
interface ActivityBulkOwnerModalProps {
  isOpen: boolean
  owners: OwnerOption[]
  onClose: () => void
...
export function ActivityBulkOwnerModal({
  isOpen,
  owners,
  onClose,
  onSubmit,
  isSubmitting = false
}: ActivityBulkOwnerModalProps) {
      ...
      <div className="w-full max-w-md overflow-hidden rounded-lg bg-white shadow-xl">
        ...
        <div className="px-6 py-5">
          <p className="text-sm text-gray-600">
            Select a new owner for the selected activities. All chosen records will be updated immediately.
          </p>

          <div className="mt-4 space-y-2">
            <label htmlFor="bulk-activity-owner" className="text-sm font-medium text-gray-700">
              New owner
            </label>
            <select
              id="bulk-activity-owner"
              value={selectedOwner}
