...
interface OpportunityBulkStatusModalProps {
  isOpen: boolean
  onClose: () => void
...
export function OpportunityBulkStatusModal({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting = false
}: OpportunityBulkStatusModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md overflow-hidden rounded-t-lg rounded-b-none bg-white shadow-xl">
        <ModalHeader kicker="Bulk Action" title="Update Status" variant="gradient" />

        <div className="px-6 py-5">
          <p className="text-sm text-gray-600">
            Choose how the selected opportunities should be marked. This updates the status for each record.
          </p>
          ...
          <div className="mt-4 space-y-3">
            <label className="flex cursor-pointer items-center gap-3 rounded-md border border-gray-200 p-3 hover:border-blue-300 hover:bg-blue-50">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Set the status to Open for all selected opportunities.</p>
              </div>
            </label>
            ...
            <label className="flex cursor-pointer items-center gap-3 rounded-md border border-gray-200 p-3 hover:border-blue-300 hover:bg-blue-50">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Set the status to Lost for all selected opportunities.</p>
              </div>
            </label>
          </div>
        </div>
