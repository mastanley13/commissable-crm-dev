...
interface ActivityBulkStatusModalProps {
  isOpen: boolean
  onClose: () => void
...
export function ActivityBulkStatusModal({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting = false
}: ActivityBulkStatusModalProps) {
      ...
      <div className="w-full max-w-md overflow-hidden rounded-t-lg rounded-b-none bg-white shadow-xl">
        ...
        <div className="px-6 py-5">
          <p className="text-sm text-gray-600">
            Choose how the selected activities should be marked. This updates the status for each record.
          </p>
          ...
          <div className="mt-4 space-y-3">
            <label className="flex cursor-pointer items-center gap-3 rounded-md border border-gray-200 p-3 hover:border-blue-300 hover:bg-blue-50">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Set status to Open for all selected activities.</p>
              </div>
            </label>
            ...
            <label className="flex cursor-pointer items-center gap-3 rounded-md border border-gray-200 p-3 hover:border-blue-300 hover:bg-blue-50">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Set status to Completed for all selected activities.</p>
              </div>
            </label>
          </div>
        </div>
