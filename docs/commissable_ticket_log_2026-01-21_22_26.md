...
| Ticket | Title | Priority | Epic/Area | Source |
|---|---|---:|---|---|
| CRM-DEP-001 | Deposit mapping UI: suggested match + prevent duplicate maps + taller table | P0 | Deposit Upload | 2026-01-21 |
| CRM-DEP-002 | Mapping review restyle: Mapped/Unmapped tabs + row count + remove sample rows | P1 | Deposit Upload | 2026-01-21 |
| CRM-DEP-003 | Merge “Review” step into mapping page | P0 | Deposit Upload | 2026-01-21 |
| CRM-DEP-004 | Disable auto-selection of first deposit line item | P1 | Deposit Detail | 2026-01-21 |
| CRM-DEP-005 | PDF support for deposit workflow (upload and/or export) | P1 | Deposit Upload | 2026-01-22 |
| CRM-DEP-006 | Multi-vendor upload option + parsing (skip Totals) | P0 | Deposit Upload | 2026-01-26 |
| CRM-DEP-007 | Deposit verification fields: Received Amt/Date/By + relabel Report Date | P0 | Deposit Detail | 2026-01-26 |
| CRM-DEP-008 | Deposit detail: vendor summary widget (allocated/unallocated by vendor) | P1 | Deposit Detail | 2026-01-26 |
| CRM-REC-001 | Reconciliation: enable multi-select | P0 | Reconciliation UI | 2026-01-21 |
| CRM-REC-002 | Reconciliation: default view = Unmatched; remove “Suggested” tab | P1 | Reconciliation UI | 2026-01-21 |
| CRM-REC-003 | Fix reconciliation summary scrollbar | P2 | Reconciliation UI | 2026-01-21 |
| CRM-REC-004 | Frozen columns + single synced horizontal scroll (top/bottom grids) | P1 | Reconciliation UI | 2026-01-26 |
| CRM-REC-005 | Fix column wrapping + currency formatting in reconciliation tables | P1 | Reconciliation UI | 2026-01-26 |
| CRM-REC-006 | Bottom grid must respond to top filters (dynamic filtering) | P0 | Reconciliation UI | 2026-01-26 |
| CRM-REC-007 | Fix commission rate display/calculation in reconciliation | P0 | Reconciliation Calc | 2026-01-26 |
| CRM-REC-008 | Add Account Legal Name to mapping + Account Name to bottom grid | P1 | Reconciliation UI | 2026-01-26 |
| CRM-MATCH-001 | Matching logic: ensure Account Legal Name + Order/Customer/House IDs are used | P0 | Matching | 2026-01-21 |
| CRM-MATCH-002 | Match-type validation wizard for 1:M / M:1 / M:M (with progress bars) | P0 | Matching | 2026-01-22 |
| CRM-MATCH-003 | Comma-separated IDs parsing + admin edits + unmatch reversal for metadata | P1 | Matching | 2026-01-22 |
| CRM-MATCH-004 | Diagnose/fix “Unmatched schedules” not showing via test script | P0 | Matching | 2026-01-26 |
| CRM-MATCH-005 | Improve AI match confidence behavior + build test schedules (e.g., VoIP) | P1 | Matching | 2026-01-26 |
| CRM-FLOW-001 | Draft/implement bundle/split logic spec (workflow + rules) | P0 | Matching Workflow | 2026-01-21 |
| CRM-FLEX-001 | Chargebacks: manager approval workflow + status “In Dispute” | P0 | Chargebacks | 2026-01-22 |
| CRM-FLEX-002 | Collections workflow triggered from Underpaid status | P1 | Collections | 2026-01-22 |
| CRM-FLEX-003 | Billing Status field + consistent statuses across entities | P0 | Status Model | 2026-01-22 |
| CRM-FLEX-004 | Flex resolution: one-time vs recurring; create additional schedules; prompt family/subtype | P0 | Flex | 2026-01-22 |
| CRM-RS-001 | Fix “Go to revenue schedule” link | P2 | Revenue Schedules | 2026-01-21 |
| CRM-RS-002 | Opportunity: add “Extend Contract” action on Revenue Schedules tab | P1 | Revenue Schedules | 2026-01-21 |
| CRM-RS-003 | Add “Change Start Date” tab (single-product), prompt reason, export order/visibility fix | P1 | Revenue Schedules | 2026-01-22 |
| CRM-OPP-001 | Opportunity Products: add “Number of Periods” column | P2 | Opportunities | 2026-01-22 |
| CRM-TIX-001 | Tickets: add Vendor Ticket ID + Vendor Contact lookup; rename fields; auto-set Created By | P1 | Tickets | 2026-01-26 |
| CRM-QA-001 | Send manual + automated UAT checklists and notes | P1 | QA/UAT | 2026-01-21 |
| CRM-QA-002 | Run end-to-end reconciliation test with Debra using real files | P0 | QA/UAT | 2026-01-22 |
| CRM-MIG-001 | Data migration approach: “Historical Transaction” placeholder product per account | P1 | Migration | 2026-01-26 |
